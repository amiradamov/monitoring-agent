...
Log storage is bounded by rotation. With the default `local_log_max_bytes` value of `5242880` and `local_log_backup_count` value of `3`, each computer keeps up to about 20 MB of local agent logs.
